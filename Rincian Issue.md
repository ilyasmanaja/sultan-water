...
**Repo:** `ilyasmanaja/sultan-water` · **Sumber data:** export langsung via `gh issue list` · **Total issue:** 81
...
| #8  | [S1-BE-04] Membuat Migrasi Tabel inventories, inventory_logs, expenses, maintenances | be   | 🟢 Open   | ShichiBan7          |
...
**Untuk apa tiket ini:** data-dictionary.md berisi definisi tabel users, customers, products, orders, order_items, inventories, inventory_logs, expenses, maintenances (kolom, tipe data, relasi FK).
...
#### [S1-BE-04] Membuat Migrasi Tabel inventories, inventory_logs, expenses, maintenances

*Issue `#8` · Status: 🟢 Open · Assignee: ShichiBan7 · Kategori: backend*

**Untuk apa tiket ini:** Migration 4 tabel + model. Field stok tutup galon, stok galon fisik (siap jual/kosong/dipinjam) dipisah dari kategori Stok Dijual vs Armada Depot.
