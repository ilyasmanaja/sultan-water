...
##### [S3-BE-09] Membuat Endpoint CRUD Admin untuk Mengubah Harga price_tiers

*Issue `#82` · Status: 🟢 Open · Assignee: ShichiBan7 · Kategori: backend ·*

**Untuk apa tiket ini:** ProductController atau PriceTierController - endpoint khusus role admin untuk update kolom price pada price_tiers (dan is_active untuk nonaktifkan tier). Perubahan harga hanya berlaku untuk transaksi BARU setelahnya - transaksi lama tidak berubah karena unit_price di order_items sudah di-snapshot.

**Kriteria selesai (Acceptance Criteria):**

- [ ] Admin bisa update harga tanpa perlu akses database langsung
- [ ] Perubahan harga langsung berlaku di transaksi berikutnya
- [ ] Transaksi lama tidak ikut berubah (snapshot tetap utuh)
- [ ] Hanya role admin yang bisa akses endpoint ini

**Bergantung pada:** S3-BE-07
...
##### [S3-FE-07] Membuat Halaman Admin untuk Mengelola Harga price_tiers

*Issue `#83` · Status: 🟢 Open · Assignee: HananiahNuriLatifah · Kategori: frontend ·*

**Untuk apa tiket ini:** Halaman sederhana di area admin: tabel 5 tier harga dengan tombol edit per baris, form update harga terhubung ke endpoint S3-BE-09.

**Kriteria selesai (Acceptance Criteria):**

- [ ] Admin bisa lihat & ubah kelima harga tier dari satu halaman
- [ ] Perubahan tersimpan dan langsung terlihat saat kasir buka form transaksi baru

**Bergantung pada:** S3-BE-09
